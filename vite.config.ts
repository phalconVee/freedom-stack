...
export default defineConfig({
  ...
  // ℹ️ This plugin should be placed before vue plugin
    ...
    // Vuetify must come immediately after vue so virtual:plugin-vuetify:components resolve (avoids 404s)
    vuetify({
      styles: {
    ...
    vueJsx(), // Docs: https://github.com/dishait/vite-plugin-vue-meta-layouts?tab=readme-ov-file
    MetaLayouts({
