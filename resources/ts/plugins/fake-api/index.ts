...
export default function () {
  // Only start MSW when fake API is enabled. When false/unset (real Laravel API), the service
  // worker is not registered, so the network tab stays clean and assets load without MSW as initiator.
